...
def create_unseen_data(opt):
    ...
    print(
        "Training data has been saved in the directory {}".format(
            f"{opt.root}/{opt.filename}/learning/raw"
        )
    )
    ...
    print(
        "Unseen data has been saved in the directory {}".format(f"{opt.root}/test/raw")
    )
